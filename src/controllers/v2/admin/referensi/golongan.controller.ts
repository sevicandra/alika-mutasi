...
export const getAllGolongan = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const createGolongan = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const updateGolongan = async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
  try {
    const { kode, nama } = req.body;
    const data = await RefGolongan.findByPk(id);
...
export const deleteGolongan = async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
  try {
    const data = await RefGolongan.findByPk(id);
    if (!data) {
