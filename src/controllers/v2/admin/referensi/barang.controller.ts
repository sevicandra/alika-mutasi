...
export const getAllBarang = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const createBarang = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const updateBarang = async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
  try {
    const { golongan, status, volume } = req.body;
    const data = await RefBarang.findByPk(id);
...
export const deleteBarang = async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
  try {
    const data = await RefBarang.findByPk(id);
    if (!data) {
