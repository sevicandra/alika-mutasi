...
export const getAllKota = async (req: AuthenticatedRequest, res: Response) => {
  const { KodeProv } = req.params;
  try {
    const limit = parseInt(req.query.limit as string) || undefined;
    const offset = parseInt(req.query.offset as string) || undefined;
...
export const getKotaById = async (req: AuthenticatedRequest, res: Response) => {
...
export const createKota = async (req: AuthenticatedRequest, res: Response) => {
  const { KodeProv } = req.params;
  try {
...
export const updateKota = async (req: AuthenticatedRequest, res: Response) => {
  const { KodeProv, KodeKota } = req.params;
  try {
    const { kota, kode } = req.body;
    const data = await RefKota.findOne({
...
export const deleteKota = async (req: AuthenticatedRequest, res: Response) => {
  const { KodeProv, KodeKota } = req.params;
  try {
    const data = await RefKota.findOne({
      where: { kode: KodeKota, kode_provinsi: KodeProv },
