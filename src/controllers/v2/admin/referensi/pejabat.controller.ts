...
export const getAllPejabat = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const createPejabat = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const updatePejabat = async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
  try {
    const { jenis, nama, nip } = req.body;
    const data = await RefPejabat.findByPk(id);
...
export const deletePejabat = async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
  try {
    const data = await RefPejabat.findByPk(id);
    if (!data) {
