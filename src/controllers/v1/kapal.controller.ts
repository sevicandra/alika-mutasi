...
export const getAllKapal = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const createKapal = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const updateKapal = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const { kapal, rute, kota_asal, kota_tujuan, tarif } = req.body;
...
export const deleteKapal = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const data = await RefKapal.findByPk(id);
    if (!data) {
