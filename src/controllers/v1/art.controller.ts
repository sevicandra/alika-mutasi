...
export const getAllArt = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getArtById = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const createArt = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const updateArt = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const deleteArt = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const data = await Art.findByPk(id);
    if (!data) {
