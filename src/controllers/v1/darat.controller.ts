...
export const getAllDarat = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const createDarat = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const updateDarat = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const { rute, kota_asal, kota_tujuan, jarak, pulau } = req.body;
...
export const deleteDarat = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const data = await RefDarat.findByPk(id);
    if (!data) {
